<template>
  <div class="flex flex-col justify-start items-center gap-y-8">
      ...
      <AppCard class="w-full">
        <div class="sm:px-6 px-3 py-6 flex flex-row justify-between items-center card__content">
          <div class="flex flex-col justify-center items-start sm:gap-0 gap-1">
            <span class="font-bold sm:text-xl text-base">Deschule Admin</span>
            <span class="text-xs text-gray-500 dark:text-gray-400">v 0.0.1</span>
          </div>
    ...
    <span class="text-grey-200 dark:text-grey-400">Deschule Admin © 2023</span>
  </div>
</template>
...
export default {
  name: 'DashboardView',
  components: { AvatarDemo, AppCard, AppButton, SignoutIcon, LinkedinIcon, GithubIcon },
};
</script>
